...
import { DropMusicController } from "../../../presentation/controllers/music/drop-music-controller";
...
export function makeDropMusicController(): BaseController {
  const controller = new DropMusicController(musicUseCases);
  return controller;
}
